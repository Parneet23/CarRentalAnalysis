...
public class RentalCarScraping {
    ...
    public RentalCarScraping(String company, String dataToWrite) {
        setFilePath(company);
...
//        String dataToWrite = scanner.nextLine();
        ...
        RentalCarScraping scraper = new RentalCarScraping(company, dataToWrite);
